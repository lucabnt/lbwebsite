...
From the ANOVA emerges how variance is statistically significant across groups defined by different focal variables *i* (*F(2, 4)= 42.187*, *p<0.01*), by different levels of *x_i* (*F(1, 4)=60.841*, *p<0.01*) and by different presentation positions *n* (*F(2, 4)=2.369*, *p<0.1*), meaning that these three dimensions are likely to predict differences in the dependent variables *y_{in}*. In addition, also the results regarding the three-way interaction *i × x_i × n* are statistically significant (*F(4)=2.681*, *p<0.05*) and provide further foundations for subsequent analyses.
